...
def parse_option():
    ...
    parser.add_argument('--K', type=int, default=500, help='memory budget')
    parser.add_argument('--save_freq', type=int, default=1, help='memory budget')
    parser.add_argument('--gpu', type=str, default='0', help='Specify gpu device [default: 0]')

    # incremental learning
    parser.add_argument('--new_classes', type=int, default=5, help='number of classes in new task')
    parser.add_argument('--start_classes', type=int, default=20, help='number of classes in old task')

    # optimization
    parser.add_argument('--lr', type=float, default=0.1, help='learning rate')
    parser.add_argument('--lr-min', type=float, default=0.0001, help='lower end of cosine decay')
    parser.add_argument('--lr_sd', type=float, default=0.01, help='learning rate for self-distillation')
    ...
    # root folders
    parser.add_argument('--data_root', type=str, default='./data/modelnet40_normal_resampled', help='root directory of dataset')
...
def train(model, old_model, epoch, lr, tempature, lamda, train_loader, use_sd, checkPoint):
    ...
    if len(test_classes) // CLASS_NUM_IN_BATCH > 1:
        ...
        old_model.eval()
        num_old_classes = old_model.fc3.out_features
...
if __name__ == '__main__':
    ...
    for i in cls_list:
        ...
        train_dataset = ModelNetDataLoader(root=args.data_root, args=args, class_cls=class_cls, split='train',
                                           process_data=args.process_data)
